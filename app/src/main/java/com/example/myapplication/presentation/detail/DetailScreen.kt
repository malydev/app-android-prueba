        ...
        when (state) {
            is UiState.Success -> {
                ...
                Column(Modifier.verticalScroll(rememberScrollState()).padding(24.dp), horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.spacedBy(20.dp)) {
                    ...
                    Surface(color = MaterialTheme.colorScheme.primaryContainer, shape = CircleShape) { Text("✓  Completado", Modifier.padding(horizontal = 16.dp, vertical = 8.dp), color = MaterialTheme.colorScheme.primary) }
